                ...
                <div className="row p-2">
                        ...
                        <div className="row">
                            ...
                            <div className="col-6 col-md-8 d-flex">
                                <div className="my-auto d-flex mentions">
                                    <a href="http://www.saint-remi.net/" rel="noreferrer" className="font-weight-bold ml-4">Mentions legales</a>
                    ...
                    <div className="col-12 col-md-4 social-media borders text-center d-flex">
                        <div className="m-auto">
                            ...
                            <a href="https://github.com/arnaudmaillet"><i className="fab fa-github fa-4x m-4" rel="noreferrer"></i></a>
